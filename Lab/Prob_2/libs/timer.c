...
void wait(uint16_t time, timeUnit_t unit, timerPin timer)
{
    ...
    case sec:
    {
        ...
        const uint16_t oneSec = 0x8000;     // Um segundo com o clock ACLK
...
// void setupCTLRegister(uint16_t * timerCTLReg, uint8_t bits, timerCTLPorts port){
//     // Máscara dos bits do registrador que serão setados
//     uint16_t mask = bit << port;
//     *timerReg |= mask;
// }

// void setupCCTLRegister(uint16_t * timerCCTLReg, uint8_t bits, timerCCTLPorts port){
//     // Máscara dos bits do registrador que serão setados
//     uint16_t mask = bit << port;
//     *timerReg |= mask;
// }
